...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "epscli",
		Short: "Command line interface for interacting with EPS blockchain daemon (server)",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of EPS node")
	...
	executor := cli.PrepareMainCmd(rootCmd, "EPS", app.DefaultCLIHome)
